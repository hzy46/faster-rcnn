...
import _init_paths
from fast_rcnn.test_post_process import test_net
...
if __name__ == '__main__':
    ...
    rcnn_raw_data_file = os.path.join(output_dir, 'raw_rcnn_data.pkl')
    print('Use rcnn_raw_data_file: %s' % rcnn_raw_data_file)
    test_net(rcnn_raw_data_file, imdb, weights_filename, vis=args.vis)
