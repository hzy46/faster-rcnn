...
class ksz_veh(imdb):
    ...
    def _get_image_set_file(self):
        return os.path.join(self._path, self._image_set + '_veh.txt')
    ...
    def _get_sz_results_file_template(self):
        ...
        if self.config['use_salt']:
            ...
            salt = ''
        filename = 'sz_veh_result_to_evaluation' + salt + self._image_set + '_{:s}.txt'
        path = os.path.join(
            self._path,
            'results',
            filename)
